        ...
        <footer className='flex flex-col text-black-100 mt-5 border-t border-gray-100'>
            <div className='flex max-md:flex-col flex-wrap justify-between gap-5 padding-x py-10'>
                <div className='flex flex-col justify-start items-start gap-6'>
                    <Image src="/logo.svg" alt='logo img' width={118} height={18} className='object-contain' />
            ...
            <div className='flex-center flex-wrap mt-10 border-t border-gray-100 padding-x py-10'>
